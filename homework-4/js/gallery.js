const Photos = [ "https://fastly.picsum.photos/id/804/300/400.jpg?hmac=Y6cx9oentnw75-Q7gYdlaJBBAnSAlUHRYXbvFMIrZNI",
...
const sectionRef = document.getElementById("unique")

for(let i = 0; i < Photos.length;i++){
    sectionRef.innerHTML += "<img " + "src= '" + Photos[i] + "' alt='Image " +  i + "' height='300'>";
}